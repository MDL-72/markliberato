...
const About: React.FC = () => {
  ...
  return (
    <section className="min-h-screen py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-900 via-blue-900 to-purple-900 relative overflow-hidden">
      {/* Animated Background */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex gap-8 items-start">
          ...
          <div className="w-80 flex-shrink-0">
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-4 border border-slate-700/50 shadow-2xl sticky top-8">
              <h3 className="text-xl font-bold text-white mb-6 text-center">About Me</h3>
                ...
                {tabs.map((tab) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full px-4 py-3 rounded-xl font-semibold transition-all duration-500 flex items-center gap-3 relative overflow-hidden text-left ${
                        activeTab === tab.id
          ...
          {activeTab === 0 && (
            <div className="space-y-12">
              {/* Main Story Section */}
              <div className="mb-16">
                <Card className="p-12 bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-slate-700/50 hover:border-cyan-500/50 transition-all duration-500 group max-w-6xl mx-auto">
                  <div className="flex flex-col lg:flex-row items-center gap-12">
                    {/* Image Section */}
                    <div className="flex-shrink-0">
                      <div className="relative">
                        <div className="w-64 h-64 rounded-2xl overflow-hidden shadow-2xl group-hover:scale-105 transition-transform duration-500">
                          <Image
                    ...
                    <div className="flex-1 text-center lg:text-left">
                      <h3 className="text-4xl font-bold text-white mb-6 group-hover:text-cyan-400 transition-colors duration-300">My Journey</h3>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
                <Card className="p-6 bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-cyan-500/30 hover:border-cyan-400/50 transition-all duration-500 group text-center">
                ...
                <Card className="p-6 bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-purple-500/30 hover:border-purple-400/50 transition-all duration-500 group text-center">
                ...
                <Card className="p-6 bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-green-500/30 hover:border-green-400/50 transition-all duration-500 group text-center">
                ...
                <Card className="p-6 bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-pink-500/30 hover:border-pink-400/50 transition-all duration-500 group text-center">
